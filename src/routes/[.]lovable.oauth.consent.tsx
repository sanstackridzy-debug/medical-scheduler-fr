...
function Consent() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-secondary via-background to-accent px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              This lets {clientName} read your shifts, appointments and requests, and submit leave
